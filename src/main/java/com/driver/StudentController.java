...
public class StudentController {
    ...
    public ResponseEntity<String> addStudentTeacherPair(@RequestParam String student, @RequestParam String teacher){
        ...
        } catch (StudentNameInvalidException exception) {
            return new ResponseEntity<>("Student name is invalid : " + student, HttpStatus.NOT_FOUND);
        } catch (TeacherInvalidException exception) {
            return new ResponseEntity<>("Teacher name is invalid : " + student, HttpStatus.NOT_FOUND);
