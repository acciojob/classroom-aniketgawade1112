...
public class StudentService {
    ...
    public void addStudentTeacherPair(String student, String teacher) throws StudentNameInvalidException {
    ...
    public Student getStudent(String name) throws StudentNameInvalidException {
        Optional<Student> studentOptional = studentRepository.getStudent(name);
